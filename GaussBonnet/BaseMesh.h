...
public:
	...
	*/
	...
	void     createHullFace(tVertex  v[], int id);
	/*! Create a face
	\param v an array of vertices
	\param id face id
	\return pointer to the new face
	...
	*/
	...
	void      deleteHullFace(tFace  pFace);
...
*/
template<typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
void CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::createHullFace(tVertex  v[], int id)
{
	CFace * f = new CFace();
	assert(f != NULL);
	f->id() = id;
...
*/
template<typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
inline void CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::deleteHullFace(tFace pFace)
{
...
*/
template<typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
void CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::read_vertices_m(const char * input)
{
	std::fstream is(input, std::fstream::in);
...
/*write Hull things*/
template<typename CVertex, typename CEdge, typename CFace, typename CHalfEdge>
void CBaseMesh<CVertex, CEdge, CFace, CHalfEdge>::writeHull_m(const char * output)
{
	std::fstream _os(output, std::fstream::out);
	if (_os.fail())
	{
